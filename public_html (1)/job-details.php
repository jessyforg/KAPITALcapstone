                ...
                ?>
                        <div class="user-card">
                            <div class="user-header">
                                ...
                                <div class="user-info">
                                    <h3><?php echo htmlspecialchars($entrepreneur_row['name']); ?></h3>
                                    <p><strong>Email:</strong> <?php echo htmlspecialchars($entrepreneur_row['email']); ?></p>
                                    <?php if (!empty($entrepreneur_row['bio'])): ?>
                                        <p><strong>Bio:</strong> <?php echo htmlspecialchars($entrepreneur_row['bio']); ?></p>
                                    <?php endif; ?>
                                </div>
                            </div>
                    ...
                    ?>
                            <div class="startup-card">
                                ...
                                <div class="startup-card-content">
                                    <h3 class="startup-card-title"><?php echo htmlspecialchars($job_seeker['name']); ?></h3>
